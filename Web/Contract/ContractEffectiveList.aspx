<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractEffectiveList.aspx.cs" Inherits="Contract_ContractEffectiveList" %>
            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="#">生效合同清单</a>
                    </div>
                </div>
            </nav>
            <div class="fr navbar">
                <asp:Button ID="btnAudit" CssClass="btn btn-default" runat="server" OnClick="btnAudit_Click" Text="同意" Visible="false" />
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='ContractAuditConfirm.aspx?ty=7&id=<%#Eval("id") %>'><%#Eval("SRM_Contract_NO")%></a>
                                    </td>
                                    <td><%#Eval("GrantNO")%></td>
                                    <td>
