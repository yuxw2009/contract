<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractApprovalConfirm.aspx.cs" Inherits="Contract_ContractApprovalConfirm" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="fr navbar">
                ...
                <asp:Button ID="btnCom" runat="server" CssClass="btn btn-default" Text="提交审核" OnClick="btnCom_Click" />
