<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractApproval.aspx.cs" Inherits="Contract_ContractApproval" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="lbl-main">
            ...
            <div class="fr navbar">
                <asp:Button ID="btnAudit" CssClass="btn btn-default" runat="server" OnClick="btnAudit_Click" Text="提交审核" />
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='ContractApprovalConfirm.aspx?id=<%#Eval("id") %>'><%#Eval("SRM_Contract_NO")%></a>
                                    </td>
                                    <td><%#Eval("GrantNO")%></td>
                                    <td>
