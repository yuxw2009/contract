<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DistributorConfirm.aspx.cs" Inherits="Contact_DistributorConfirm" %>
            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="#">合同确认</a>
                    </div>
                </div>
            </nav>
            <div class="fr navbar">
                ...
                <asp:Button ID="btnCom" runat="server" CssClass="btn btn-default" Text="确认合同" OnClick="btnCom_Click" />
                <input type="button" class="btn btn-default" onclick="MyBack()" value="回退" />
                <button type="button" class="btn btn-default" onclick="javascript:location.href='Distributor.aspx'">退出</button>
            </div>
